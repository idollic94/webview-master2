...
public class imflint extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefsEditor.putString("firsttime", "4");
        prefsEditor.commit();
    ...
    public void swinsta (View view){
        ...
        Intent intent = new Intent(imflint.this, igflint.class);
        startActivity(intent);
    }
    public void swfb (View view){

        Intent intent = new Intent(imflint.this, fbflint.class);
        startActivity(intent);
    }
    public void swtwitter (View view){

        Intent intent = new Intent(imflint.this, twflint.class);
        startActivity(intent);
    }
    @Override
