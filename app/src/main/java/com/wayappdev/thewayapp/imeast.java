...
public class imeast extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefsEditor.putString("firsttime", "3");
        prefsEditor.commit();
    ...
    public void swinsta (View view){
        ...
        Intent intent = new Intent(imeast.this, igeast.class);
        startActivity(intent);
    }
    public void swfb (View view){

        Intent intent = new Intent(imeast.this, fbeast.class);
        startActivity(intent);
    }
    public void swtwitter (View view){

        Intent intent = new Intent(imeast.this, tweast.class);
        startActivity(intent);
    }
    @Override
